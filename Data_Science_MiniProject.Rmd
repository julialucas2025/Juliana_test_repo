...
summary(model)
#The model in comparison of all continuous variables against heart rate is particular significant since p-value: 2.51e-05 = 0.0000251 which is within the recommended range p-value < 0.05. However, the model is overall not fit to these data since the Adjusted R-square is less than 60% 0.6 for all variables
```
