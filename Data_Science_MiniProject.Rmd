...
```
```{r}
boxplot(HeartRate~Age, data = maternal)
#boxplot(Age~HeartRate, data = maternal)
#boxplot(DiastolicBP~HeartRate, data = maternal)
#boxplot(SystolicBP~HeartRate, data = maternal)
#boxplot(BodyTemp~HeartRate, data = maternal)
```
